...
function spreadProps({ className, style }: IconProps) {
  return { className, style };
}

const defaultProps = (size = 'w-5 h-5'): Partial<IconProps> => ({ className: size });
...
export function IconStar(props: IconProps) {
  const p = { ...defaultProps('w-4 h-4'), ...props };
  return (
    <svg {...spreadProps(p)} viewBox="0 0 24 24" fill="currentColor">
